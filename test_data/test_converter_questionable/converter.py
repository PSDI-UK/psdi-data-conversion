"""@file test_data/test_converter_questionable/converter.py

Test file converter, a complex case where one of the formats potentially clashes with a format already in the database
"""
...
class TestFileConverterQuestionable(FileConverter):
...
converter = TestFileConverterQuestionable
