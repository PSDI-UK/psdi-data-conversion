...
basic_tests = ConversionTestSpec(name="Basic",
...
archive_callback = MultiCallback(CheckFileStatus(),
                                 CheckArchiveContents(l_filename_bases=["caffeine-no-flags",
                                                      ...
                                                      to_format="inchi"))
archive_tests = ConversionTestSpec(name="Archive",
...
archive_wrong_format_test = ConversionTestSpec(name="Archive (wrong format)",
                                               filename="caffeine-smi.zip",
                                               to_format="inchi",
...
log_mode_tests = ConversionTestSpec(name="Log mode",
...
stdout_test = ConversionTestSpec(name="Stdout",
...
quiet_test = ConversionTestSpec(name="Quiet",
                                conversion_kwargs={"log_mode": const.LOG_NONE},
...
open_babel_warning_test = ConversionTestSpec(name="Open Babel Warning",
                                             filename="1NE6.mmcif",
                                             to_format="pdb",
...
invalid_converter_test = ConversionTestSpec(name="Invalid Converter",
...
quality_note_test = ConversionTestSpec(name="Quality note",
                                       filename="quartz.xyz",
                                       to_format="inchi",
...
cleanup_input_test = ConversionTestSpec(name="Cleanup input",
...
failed_conversion_test = ConversionTestSpec(name="Failed Conversion",
...
max_size_test = ConversionTestSpec(name="Max size",
...
format_args_test = ConversionTestSpec(name="Format args",
...
coord_gen_test = ConversionTestSpec(name="Coord gen",
                                    filename="caffeine.inchi",
                                    to_format="xyz",
                                    conversion_kwargs=[{},
