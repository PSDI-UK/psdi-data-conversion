...
l_all_test_specs.append(Spec(name="Failed conversion - bad input file",
                             filename=["quartz_err.xyz", "quartz_err.xyz", "quartz_err.xyz", "cyclopropane_err.mol"],
                             to_format=["inchi", "mol-0", "pdb", "xyz-0"],
                             from_format=[None, None, None, "mol-0"],
                             expect_success=[False, True, True, False],
                             converter_name=[CONVERTER_OB, CONVERTER_OB, CONVERTER_ATO, CONVERTER_C2X],
