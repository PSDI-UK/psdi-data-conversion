...
basic_tests = ConversionTestSpec(filename=["1NE6.mmcif", "hemoglobin.pdb", "nacl.cif", "hemoglobin.pdb", "nacl.cif",
                                           "standard_test.cdxml"],
                                 to_format=["pdb", "cif", "xyz", "cif", "xyz", "inchi"],
                                 name=[CONVERTER_OB, CONVERTER_ATO, CONVERTER_ATO, CONVERTER_C2X, CONVERTER_C2X],
